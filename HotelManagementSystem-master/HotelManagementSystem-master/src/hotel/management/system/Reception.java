...
public class Reception extends JFrame implements ActionListener{
    JButton newCustomer,rooms,department,allEmployee,customers,managerInfo,checkout,update,roomUpdate,pickup,searchRoom,logout;
    Reception(){
        ...
        image.setBounds(200,50,600,500);
        add(image);
